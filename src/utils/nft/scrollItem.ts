...
export function mapEnrichedNFTToFilterableItem(
    ...
    return {
        ...
        metadata: nft.metadata ? {
            ...
            imageOriginal: nft.metadata.imageOriginal || null,
            images: nft.metadata.images || undefined,
            imageMeta: nft.metadata.imageMeta || undefined,
...
export function mapWalletNFTToScrollItem(nft: WalletNFT, connectedWallet?: string | null): NFTScrollItem {
    ...
    return {
        ...
        metadata: {
            ...
            imageOriginal: (nft as any).imageOriginal || nft.image || null,
            images: (nft as any).images || undefined,
            imageMeta: (nft as any).imageMeta || undefined,
            blurDataURL: (nft as any).blurDataURL || null,
