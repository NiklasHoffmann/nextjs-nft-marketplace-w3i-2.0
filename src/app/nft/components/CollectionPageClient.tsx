                            ...
                            <div className="flex-1 max-w-3xl">
                                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                                    ...
                                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 hover:shadow-md transition-shadow">
                                        ...
                                        <p className="text-xl font-bold text-purple-600">{collectionStats?.totalListings || 0}</p>
                                    </div>
                                    ...
                                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 hover:shadow-md transition-shadow">
                                        ...
                                        <p className="text-base font-bold text-green-600">
                                            {collectionStats?.minPrice && collectionStats.minPrice > 0
                                    ...
                                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 hover:shadow-md transition-shadow">
                                        ...
                                        <p className="text-base font-bold text-blue-600">
                                            {collectionStats?.totalVolume.toFixed(3) || '0'} ETH
                                        </p>
                                    </div>
                                    ...
                                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 hover:shadow-md transition-shadow">
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            <span className="text-xs font-medium text-gray-600">Owners</span>
                                        </div>
                                        <p className="text-xl font-bold text-indigo-600">{collectionStats?.uniqueOwners || 0}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
