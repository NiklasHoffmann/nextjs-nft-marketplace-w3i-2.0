...
export default function NFTDetailHeader({
    ...
    // This prevents stale data when stats object reference doesn't change
                ...
                <div className="flex items-center justify-between py-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">
                                {formatCollectionDisplayName(contractName, collection, contractSymbol, contractAddress)}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="hidden md:flex items-center gap-6 text-sm text-gray-600">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <span className="min-w-[30px]">{displayStats.likeCount}</span>
                        </div>
                        <div className="flex items-center gap-1">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        >
                            <svg className="w-4 h-4" fill={displayUserInteractions.isWatchlisted ? 'currentColor' : 'none'} stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
                            </svg>
                        </button>
