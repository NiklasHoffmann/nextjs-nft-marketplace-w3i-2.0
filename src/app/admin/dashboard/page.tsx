...
interface DashboardStats {
    ...
    listedVolume: number;      // Summe der Preise von gelisteten Items
    salesVolume: number;        // Summe der Preise von verkauften Items
    totalVolume: number;        // Backwards compatibility
    totalUsers: number;
    totalSales: number;
    ...
    return (
        <AdminPageShell>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-6">
                            <div className="flex items-center justify-between mb-2">
                                <span className="text-sm font-medium text-gray-600">Listed Volume</span>
