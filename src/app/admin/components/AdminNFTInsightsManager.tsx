...
export default function AdminNFTInsightsManager() {
    ...
    }, [existingInsights, collectionInsights, insightsLoading, collectionInsightsLoading, formData.contractAddress, formData.tokenId]);
    ...
    const handleSubmit = useCallback(async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isEditMode && existingInsights) {
                // Update existing insights - add _id for MongoDB update
                result = await update({
                    ...requestData,
                    _id: existingInsights._id // MongoDB ObjectId required for update
                });
    ...
    return (
        <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="mb-6">
                ...
                {(insightsLoading || collectionInsightsLoading) && (
