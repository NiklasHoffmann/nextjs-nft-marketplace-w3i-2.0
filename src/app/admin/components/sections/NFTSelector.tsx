 ...
 * 
 * Features:
 * - ðŸ“ Contract Address Input mit Validation
 * - ðŸ”¢ Token ID Input  
        ...
        <div className="space-y-4 border-t pt-6">
            <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                    WÃ¤hle Contract Address (erforderlich) und optional Token ID fÃ¼r spezifische NFT-Insights
                </p>
            </div>
                ...
                <div>
                    ...
                    {contractAddress.length > 0 && !isValidAddress(contractAddress) && (
                        <p className="mt-1 text-sm text-red-600">
                            UngÃ¼ltige Ethereum-Adresse. Format: 0x + 40 Hex-Zeichen
                        </p>
                    )}
                </div>
                ...
                <div>
                    ...
                    <div className="relative">
                        <input
                            ...
                            placeholder="z.B. 1234 (optional fÃ¼r Collection-weite Insights)"
                        />
                        ...
                        <div className="flex-1">
                            <span className="text-sm font-medium text-blue-800">
                                {tokenId && isValidTokenId(tokenId)
                                    ? `ðŸŽ¯ NFT-spezifisch: ${(contractAddress || '').slice(0, 6)}...${(contractAddress || '').slice(-4)} #${tokenId}`
                                    : `ðŸŒ Collection-weit: ${(contractAddress || '').slice(0, 6)}...${(contractAddress || '').slice(-4)}`
                                }
                            </span>
                            <div className="text-xs text-gray-600 mt-1">
                                {tokenId && isValidTokenId(tokenId)
                                    ? 'Insights gelten nur fÃ¼r dieses spezifische NFT'
                                    : 'Insights gelten fÃ¼r die gesamte Collection'
                                }
                            </div>
                        </div>
                    </div>
