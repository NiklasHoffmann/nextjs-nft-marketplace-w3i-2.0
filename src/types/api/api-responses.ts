...
export interface AdminNFTInsight {
  ...
  description?: string;
  descriptions?: string[];  // ? Legacy: Array f�r mehrere Descriptions  
  projectDescriptions?: NFTProjectDescriptions; // ? Enhanced: Project-spezifische Beschreibungen
  functionalitiesDescriptions?: NFTFunctionalitiesDescriptions; // ? Enhanced: Funktionalit�ts-spezifische Beschreibungen
