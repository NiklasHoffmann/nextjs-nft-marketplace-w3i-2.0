...
export type NftCore = {
    ...
    contractName?: string | null // falls verfügbar vom Contract/Enumerable
    contractSymbol?: string | null // falls verfügbar vom Contract/Enumerable
    totalSupply?: number | null // falls verfügbar vom Contract/Enumerable
}
...
// Normalisiertes Ergebnis je NFT (einheitlich für Cards/Detail/Wallet)
...
// Zusammenfassung je Collection (für Tabellen & Collection-Page)
