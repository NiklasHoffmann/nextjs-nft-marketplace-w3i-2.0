...
export enum DiamondOperation {
    ...
    ADD_BUYER_WHITELIST_ADDRESSES = 'addBuyerWhitelistAddresses',
    REMOVE_BUYER_WHITELIST_ADDRESSES = 'removeBuyerWhitelistAddresses',
    ADD_ALLOWED_CURRENCY = 'addAllowedCurrency',
    REMOVE_ALLOWED_CURRENCY = 'removeAllowedCurrency',
...
> = {
    ...
    [DiamondOperation.ADD_BUYER_WHITELIST_ADDRESSES]: {
        operation: DiamondOperation.ADD_BUYER_WHITELIST_ADDRESSES,
        label: 'Add Buyer Whitelist',
        description: 'Allow buyers for a specific listing',
        functionSignature: 'addBuyerWhitelistAddresses(uint128,address[])',
        args: [
            {
                name: 'listingId',
                type: 'uint128',
                placeholder: '1',
                description: 'Listing ID to whitelist buyers for',
            },
            {
                name: 'allowedBuyers',
                type: 'address[]',
                placeholder: '0x..., 0x..., 0x...',
                description: 'Buyer addresses to allow',
            },
        ],
        requiresMultiSig: true,
    },
    [DiamondOperation.REMOVE_BUYER_WHITELIST_ADDRESSES]: {
        operation: DiamondOperation.REMOVE_BUYER_WHITELIST_ADDRESSES,
        label: 'Remove Buyer Whitelist',
        description: 'Remove buyers from a listing whitelist',
        functionSignature: 'removeBuyerWhitelistAddresses(uint128,address[])',
        args: [
            {
                name: 'listingId',
                type: 'uint128',
                placeholder: '1',
                description: 'Listing ID to remove buyers from',
            },
            {
                name: 'disallowedBuyers',
                type: 'address[]',
                placeholder: '0x..., 0x..., 0x...',
                description: 'Buyer addresses to remove',
            },
        ],
        requiresMultiSig: true,
    },
    [DiamondOperation.ADD_ALLOWED_CURRENCY]: {
        operation: DiamondOperation.ADD_ALLOWED_CURRENCY,
        label: 'Add Allowed Currency',
        description: 'Allow a payment currency for listings',
        functionSignature: 'addAllowedCurrency(address)',
        args: [
            {
                name: 'currency',
                type: 'address',
                placeholder: '0x...',
                description: 'ERC20 token address or wrapped native token',
            },
        ],
        requiresMultiSig: true,
    },
    [DiamondOperation.REMOVE_ALLOWED_CURRENCY]: {
        operation: DiamondOperation.REMOVE_ALLOWED_CURRENCY,
        label: 'Remove Allowed Currency',
        description: 'Remove a payment currency from allowlist',
        functionSignature: 'removeAllowedCurrency(address)',
        args: [
            {
                name: 'currency',
                type: 'address',
