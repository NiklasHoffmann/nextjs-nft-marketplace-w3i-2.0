    ...
    return (
        <header className="w-full fixed bg-primary shadow flex items-center px-6 py-3 z-50">
            ...
            <div className="flex items-center gap-4 ml-6">
                ...
                <Link href="/insights" className="text-gray-700 hover:text-blue-600 font-medium">Insights</Link>
                                    ...
                                    <div className="px-4 py-3">
                                        ...
                                        <div className="mb-3">
                                            <Link
                                                href="/insights"
                                                onClick={() => setIsDropdownOpen(false)}
                                                className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-700 bg-purple-50 border border-purple-200 rounded-lg hover:bg-purple-100 transition-colors"
                                            >
