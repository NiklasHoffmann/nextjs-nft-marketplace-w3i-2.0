...
function NFTTabNavigation({ activeTab, onTabChange, isWalletConnected = false }: NFTTabNavigationProps) {
    // Memoize tabs array with better organization - filter personal tab if no wallet
    const tabs = useMemo(() => {
        const allTabs = [
            {
            ...
            // Only show personal tab if wallet is connected
            ...(isWalletConnected ? [{
    ...
    return (
        <div className="border-b border-gray-200 bg-gray-50 py-2 bg-primary overflow-auto">
