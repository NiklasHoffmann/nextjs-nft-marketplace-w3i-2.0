 ...
 * 
 * Features:
 * - âž• Add Description Button
 * - âŒ Remove Description Button  
 * - ðŸ“ Individual Text Inputs
 * - ðŸ”¢ Auto-numbering
...
export default function DynamicDescriptionManager({
    label = "Descriptions",
    helpText = "FÃ¼ge Beschreibungen hinzu oder entferne sie",
    descriptions,
    onChange,
    maxDescriptions = 10,
                        ...
                        <div className="flex-1">
                            ...
                            <div className="mt-1 flex items-center justify-between">
                                ...
                                <div className={`text-xs ${(maxCharactersPerDescription - description.length) < 10
                                    ...
                                    {maxCharactersPerDescription - description.length} Zeichen Ã¼brig
                                </div>
                            </div>
                        </div>
