...
import { AVAILABLE_CATEGORIES, AVAILABLE_RARITIES } from '@/types/marketplace';
                        ...
                        <div className="hidden sm:flex items-center gap-2">
                            {SORT_OPTIONS.slice(0, 5).map((option) => (
                                ...
                                >
                                    ...
                                    {/* Platzhalter fÃ¼r Pfeil - immer da, aber nur sichtbar wenn aktiv */}
                                    <svg
                    ...
                    <div className="mt-2 sm:mt-3 pt-2 sm:pt-3 border-t border-gray-100">
                        <div className="flex flex-wrap gap-1 sm:gap-1.5 items-center">
                            ...
                            {filters.minViews && (
                                ...
                                >
                                    <span>ðŸ‘ï¸ {filters.minViews}+</span>
                                    <svg className="w-3 h-3 opacity-60 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                                </button>
                            ...
                            {filters.minLikes && (
                                ...
                                >
                                    <span>â¤ï¸ {filters.minLikes}+</span>
                                    <svg className="w-3 h-3 opacity-60 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                                </button>
                            ...
                            {filters.minWatchlistCount && (
                                <button
                                    ...
                                    className="group flex items-center gap-1 px-2 py-1 text-xs bg-blue-50 text-blue-700 rounded-md hover:bg-blue-100 transition-colors border border-blue-200"
                                >
                                    <span>ðŸ”– {filters.minWatchlistCount}+</span>
                                    <svg className="w-3 h-3 opacity-60 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                                </button>
                            ...
                            {filters.searchTerm && (
                                ...
                                >
                                    <span>ðŸ” "{filters.searchTerm}"</span>
                                    <svg className="w-3 h-3 opacity-60 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                                </button>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200 space-y-4 animate-in slide-in-from-top-4 fade-in duration-200">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <span className="text-xs text-gray-500">{filters.categories.length} ausgewÃ¤hlt</span>
                            </div>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <span className="text-xs text-gray-500">{filters.rarities.length} ausgewÃ¤hlt</span>
                            </div>
                            <div className="flex flex-wrap gap-1.5">
