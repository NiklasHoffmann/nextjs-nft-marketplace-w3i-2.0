...
export function NFTGallery({
    ...
    const buildCardProps = useCallback((item: NFTScrollItem, cardPriority: boolean) => ({
        ...
        seller: item.seller,
        buyer: item.buyer,
        desiredContractAddress: item.desiredContractAddress || (item as any).desiredTokenAddress || (item as any).marketplace?.desiredContractAddress || (item as any).marketplace?.desiredTokenAddress,
        desiredTokenId: item.desiredTokenId || (item as any).marketplace?.desiredTokenId,
        currency: item.currency,
        chainId: item.chainId,
        listingType: item.listingType || (item as any).marketplace?.listingType,
