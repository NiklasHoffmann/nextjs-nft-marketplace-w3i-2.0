...
// This gives all nfts of a collection
export const GET_NFTS_BY_COLLECTION = gql`
    query GetNFTsByCollection($collectionAddress: Bytes!) {
        items(where: { nftAddress: $collectionAddress }, orderDirection: desc, first: 1000) {
            nftAddress
            tokenId
            owner
            seller
